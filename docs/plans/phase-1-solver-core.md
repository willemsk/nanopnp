...
**Status: WP7, WP8, WP9, WP10, WP11 and WP12 delivered; WP13 planned, not started** ([plan](wp13-tier3-comsol-comparison.md)). Written 2 September 2026, after Phase 0
...
Planned in full in [`wp13-tier3-comsol-comparison.md`](wp13-tier3-comsol-comparison.md), which
supersedes this paragraph on the rung count and on the frozen case set.
