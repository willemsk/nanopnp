...
| 3 | Index ruling 2: permittivity fit = authors' Buchner values (29.50, 11.74); "confirmed by the 42.12 cap" | **The model used Gavish: `epsr_ms = 30.08`, `epsr_alpha = 11.5`**, matching the ESI text | Ruling 2 is contradicted by the shipped model. With 30.08/11.5, `εr(5.3 M) = 42.67`; with 29.50/11.74, 42.13. The 42.12 cap therefore came from the Buchner fit, **not** from what was solved. Re-put to the author. **[verified]** |
